...
//  Serial.println(vIN);
  if(Serial.available())
   {
    desiredTransistorStatus=Serial.readStringUntil('\n').toInt();
    desiredTransistorStatus2=Serial.readStringUntil('\n').toInt();
    desiredTransistorStatus3=Serial.readStringUntil('\n').toInt();
    desiredTransistorStatus4=Serial.readStringUntil('\n').toInt(); 
    
    forcedTransistorStatus = Serial.readStringUntil('\n').toInt();
    forcedTransistorStatus2= Serial.readStringUntil('\n').toInt();
    forcedTransistorStatus3= Serial.readStringUntil('\n').toInt();
    forcedTransistorStatus4= Serial.readStringUntil('\n').toInt();
  }
